...
--- 計算 DomainName 的造訪次數
request_domains_count = FOREACH grp GENERATE CONCAT(CONCAT(CONCAT(CONCAT(group.UserId, '_'), group.DumpDate), '_'), group.DomainName) AS key:chararray, group.UserId, group.DumpDate, group.DomainName, COUNT(logs_with_right_data) AS ReqCount:long;
