...
countingFilterResult_6 = FOREACH countingFilterResult_6 GENERATE * AS (UniqueId:chararray, Visited:long);
    ...
    JoinResult_7 = JOIN countingFilterResult_3 BY UniqueId FULL, countingFilterResult_6 BY UniqueId;
    JoinResult_7TMP1 = FILTER JoinResult_7 BY countingFilterResult_3::UniqueId != '';
    JoinResult_7TMP2 = FILTER JoinResult_7 BY countingFilterResult_6::UniqueId != '';
    JoinResult_7TMP2 = FOREACH JoinResult_7TMP2 GENERATE countingFilterResult_6::UniqueId AS countingFilterResult_3::UniqueId, $1 ..;
    JoinResult_7 = UNION JoinResult_7TMP1, JoinResult_7TMP2;
    JoinResult_7 = DISTINCT JoinResult_7;
